...
PRETRAINED_VOCAB_ARCHIVE_MAP = {
    ...
    'dmis-lab/biobert-base-cased-v1.1': 'https://huggingface.co/dmis-lab/biobert-base-cased-v1.1/raw/main/vocab.txt'
...
PRETRAINED_VOCAB_POSITIONAL_EMBEDDINGS_SIZE_MAP = {
    ...
    'dmis-lab/biobert-base-cased-v1.1': 512,
...
class BertTokenizer(object):
    ...
    def __init__(self, vocab_file, do_lower_case=True, max_len=None,
                 never_split=("[UNK]", "[SEP]", "[PAD]", "[CLS]", "[MASK]", "[unused99]", "[unused1]", "[unused2]", "[unused3]", "[unused4]", "[unused5]", "[unused6]","[unused99]")):
